...
class Settings(BaseSettings):
    ...
    app_name: str = "BrightHive Loadstress Infrastructure CDK"
    ...
    @property
    def is_loadstress(self) -> bool:
        """Check if running in loadstress mode."""
        return self.environment == Environment.LOADSTRESS
