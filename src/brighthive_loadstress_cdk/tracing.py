...
def setup_tracing(
    service_name: str = "brighthive_loadstress_cdk",
    ...
    Example:
        >>> from brighthive_loadstress_cdk.tracing import setup_tracing
...
def get_tracer(name: str) -> trace.Tracer:
    ...
    Example:
        >>> from brighthive_loadstress_cdk.tracing import get_tracer
